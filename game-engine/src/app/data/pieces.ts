...
export const PIECE_LIBRARY: GamePiece[] = [
  ...
  // Equipment
  {
    ...
    tags: ['equipment', 'filter'],
    cost: 2,
    abilities: ['+1 Water Quality']
  },
